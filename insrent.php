...
<?php
    ...
    {   
        ...
        $mail=$_SESSION["Email"];
        if(empty($pn) || empty($ptype) || empty($descr) || empty($due) || empty($price)){
            ?>
            <div class="mess">
        ...
        $insert="insert into rent(pname,ptype,descrip,due,price,pimg,id,name,email) values('$pn','$ptype','$descr','$due','$price','$image','$id','$name','$mail')";

        ...
        <div class="container">
          ...
          for($i =1;$i<=$norow;$i++){
            ...
            for($j=1;$j<=3;$j++){
              ...
              <div class="cards">
              <div class="imag">
                   <img src="donate/<?php echo $row['pimg']?>" height="200" class="card-img-top" alt="...">
              </div>
              <div class="desc">
                ...
                <a href="donform.php?id=<?php echo $row['pid']?>"><input class="btn1" type="button" name="donate" value="Buy Donated Product"></a>
              </div>
             </div>
      <?php
              }
...
if(isset($_POST['submit']))
{
    ...
    {
      $select="select * from donate where ptype='$filt'";
      $res=mysqli_query($conn,$select);
      $data=mysqli_num_rows($res);
      $norow=($data/3)+1;

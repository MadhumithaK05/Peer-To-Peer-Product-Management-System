...
if($flag=="true" && empty(isset($_POST['submit'])))
{
      ...
      $select="select * from sell where Available='Yes'";
        ...
        <div class="container">
          ...
          for($i =1;$i<=$norow;$i++){
            ...
            for($j=1;$j<=3;$j++){
              ...
              <div class="cards">
                  <div class="imag">
                  <img src="sell/<?php echo $row['pimg']?>" height="200" class="card-img-top" alt="...">
                  </div>
                  <div class="desc">
                      ...
                      <a href="buyform.php?id=<?php echo $row['pid']?>"><input class="btn1" type="button" name="buy" value="Buy"></a>
...
if(isset($_POST['submit']))
{
    ...
    $filt=$_POST['ptype'];
      ...
      $select="select * from sell where Available='Yes' and price<300";
      $res=mysqli_query($conn,$select);
      $data=mysqli_num_rows($res);
      $norow=($data/3)+1;
            ...
            for($j=1;$j<=3;$j++){
              ...
              <div class="cards">
                  ...
                  <div class="desc">
                      ...
                      <h4 style="font-family :serif;"><?php echo "Description:".$row['descrip'] ?></h4>
                      <h4 style="font-family :serif; color:blue;"><?php echo "Rs.".$row['price'] ?></h4>
                      <a href="buyform.php?id=<?php echo $row['pid']?>"><input type="button" name="buy" class="btn1" value="Buy"></a>
                      <a href="chat.php?id=<?php echo $row['id']?>"><input class="btn1" type="button" name="chat" value="Chat"></a>
                  </div>
              </div>
      <?php
    ...
    else
    {
      if(empty($filt))
      {
        ...
        $select="select * from sell where Available='Yes' and ptype='$filt' and price<300";
      }
     ...
     else
     {
      if(empty($filt))
      {
       ...
       <?php
        ...
        {
          $select="select * from sell where Available='Yes' and ptype='$filt'";
          $res=mysqli_query($conn,$select);
          $data=mysqli_num_rows($res);
          $norow=($data/3)+1;

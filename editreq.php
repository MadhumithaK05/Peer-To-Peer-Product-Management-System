...
include 'conn.php';
$id=$_GET['id'];
$select="select * from request where pid='$id'";
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="content">
                    ...
                    <div>
                        ...
                        <input class="form2" type="number" name="own" placeholder="own" value="<?php echo $fetch['own']?>">
                    </div>
...
<?php
    ...
    if(isset($_POST['update_btn'])){
        ...
        $du=$_POST['due'];
        $ow=$_POST['own'];
        $update="update request set  pname='$pn',ptype='$pt',due='$du',own='$ow' where pid='$id'";
